  ...
  return (
    <div className="global">
      ...
      <div className="body p-4">
        ...
        <h3 className="titulo">Guía para legalización</h3>
        <br />
        <div className="container centrales ms-2">
          <p className="d-block col-md-6">
            <a className="btn btn-primary " style={{ backgroundColor: "blueviolet" }} data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
            ...
            <br />
            <button className="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="false" aria-controls="collapse2" style={{ backgroundColor: "blueviolet" }}>
          ...
          <div className="collapse" id="collapse2">
            <div className="card card-body">
              <div className="list-group" >
                ...
                <p className="list-group-item list-group-item-action">Los trámites para que una persona pueda acceder a una condición migratoria regular en Colombia se hacen en el Ministerio de Relaciones Exteriores o en Migración Colombia. Recuerde que las gestiones con Migración Colombia pueden ser realizadas de manera virtual, son gratuitos y no necesita intermediarios. </p>
              </div>
            </div>
          </div>

          <p>
            <button className="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="false" aria-controls="collapse3" style={{ backgroundColor: "blueviolet" }}>
            ...
            <button className="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="false" aria-controls="collapse4" style={{ backgroundColor: "blueviolet" }}>
              Tarjeta de movilidad fronteriza-TMF
            </button>
            <div className="collapse" id="collapse4">
              <div className="card card-body">
                <p>
                  Documento que permite ingresar y transitar libremente por zonas fronterizas, estudiar primaria o secundaria; realizar turismo en zonas de frontera, visitar familiares y comprar medicamentos. No permite ingresar al interior del país, vivir en Colombia o afiliarse al sistema de salud.
                </p>
              </div>
            </div>
            <br/>
            ...
            <button className="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapse6" aria-expanded="false" aria-controls="collapse6" style={{ backgroundColor: "blueviolet" }}>
            ...
            <button className="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapse7" aria-expanded="false" aria-controls="collapse7" style={{ backgroundColor: "blueviolet" }}>
            ...
            <div className="list-group">
            <button className="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapse5" aria-expanded="false" aria-controls="collapse5" style={{ backgroundColor: "blueviolet" }}>
            Documentos
            </button>
            <div className="collapse" id="collapse5">
                <div className="card card-body">
            <p>
            Aquí se deben colocar los documentos.
            </p>
            <Images />
            <a href="documentos" className="list-group-item list-group-item-action">Seguimiento de documentos:</a>
                     </div>
                </div>
            </div>
        </div>
